...
class Config:
    ...
    im_post_comment: bool = False
    im_upload_onebox: bool = True
    webhook_post_comment: bool = True
    webhook_upload_onebox: bool = False
    ...
    coordination_db_path: Path = Path("log/review-coordination.sqlite3")
    max_files: int = 50
    ...
    def from_env(cls, dotenv_path: Path | None = None) -> "Config":
        ...
        return cls(
            ...
            im_post_comment=_parse_bool(get("IM_POST_COMMENT", "false")),
            im_upload_onebox=_parse_bool(get("IM_UPLOAD_ONEBOX", "true")),
            webhook_post_comment=_parse_bool(get("WEBHOOK_POST_COMMENT", "true")),
            webhook_upload_onebox=_parse_bool(get("WEBHOOK_UPLOAD_ONEBOX", "false")),
            ...
            coordination_db_path=Path(get("COORDINATION_DB_PATH", "log/review-coordination.sqlite3")),
